...
<div class="content">
  ...
  <button class="collapsible"><mark style="color:black;font-size:11px;background:#f5f5f5">LEVERAGING TEXT DATA TO STUDY THE IMPACT OF NEWS SOURCE ON DISCOURSE</mark> <mark style="color:gray;font-size:11px;background:#f5f5f5">[NLP; ETL PIPELINE; TRANSFORMER MODELS; BIG TEXT DATA]</mark></button>
...
<button class="collapsible"><mark style="color:black;font-size:11px;background:#f5f5f5">IMPLEMNTING LARGE SCALE SURVEY EXPERIMENTS </mark> <mark style="color:gray;font-size:11px;background:#f5f5f5"> [RESEARCH DESIGN; SURVEY CREATION & IMPLEMENTATION; JOURNAL SUBMISSION] </mark></button>
<div class="content">
  <p><ul>
 <h2 style="color:Black;font-size:18px;"> Main Contributions</h2>
