...
<li> Presented project at The Annual Conference for Political Methodology (displayed below) </li>
</ul>
<ul>
 <div class="div-img">
 ...
 <h2 style="color:Black;font-size:18px;"> Summary</h2>
...
<div class="content">
  <p><ul>
<li> Prepared replication file for( [https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/YOGY5W](Harvard Dataverse) <br>
  </ul></p>
</div>

  <button class="collapsible"> </mark> <mark style="color:gray;font-size:11px;background:#f5f5f5"><mark style="color:black;font-size:11px;background:#f5f5f5"></mark>/button>
