...
<div class="content">
  ...
  <button class="collapsible"><mark style="color:black;font-size:11px;background:#f7f7f7">USING TEXT DATA TO STUDY THE IMPACT OF NEWS SOURCE ON DISCOURSE</mark> <mark style="color:#B8C0AF;font-size:11px;background:#f7f7f7">[NLP; ETL; LLM; TRANSFORMER MODELS; BIG DATA]</mark></button>
...
<p style="padding-left: 5px;"> I then developed a program that allowed users to automatically extract useful metrics from the data, store the cleansed data in a SQL database and prevent duplicate data processing. This program included preprocessing the text data with methods such as removing unnecessary characters, renaming columns, extracting links, tokenization, lemmatization and calculating various text-based metrics like average word length and total word count. Other features include an  unsupervised learning algorithm for obtaining vector representations of words and computing the subjectivity, polarity, and sentiment analysis scores for each tweet</p>
  ...
  <button class="collapsible"><mark style="color:black;font-size:11px;background:#f7f7f7">IDENTIFYING WHAT CONSTITUTES A POLITICAL ADVERTISEMENT </mark> <mark style="color:#B8C0AF;font-size:11px;background:#f7f7f7">
...
<button class="collapsible"><mark style="color:black;font-size:11px;background:#f7f7f7">MEASURING THE EFFICACY OF IN-GROUP CORRECTIONS</mark> <mark style="color:#B8C0AF;font-size:11px;background:#f7f7f7">[EXPERIMENTAL DESIGN; DATA ANALYSIS & VISUALIZATION]</mark></button>
 <div class="content">
  <h3 style="color:Black;font-size:18px;"> Summary</h3>
...
<button class="collapsible"><mark style="color:black;font-size:11px;background:#f7f7f7">IMPLEMENTING LARGE SCALE SURVEY EXPERIMENTS </mark> <mark style="color:#B8C0AF;font-size:11px;background:#f7f7f7"> [RESEARCH DESIGN; SURVEY CREATION & IMPLEMENTATION; PUBLICATION] </mark></button>
...
<iframe src="images/typ.pdf" frameborder="0" allowfullscreen>></iframe>
</div>
...
<button class="collapsible"><mark style="color:black;font-size:11px;background:#f7f7f7">INTRODUCTION TO PYTHON FOR PUBLIC HEALTH MASTERS' </mark> <mark style="color:#B8C0AF;font-size:11px;background:#f7f7f7"> [INSTRUCTION; MACHINE LEARNING; NLP; OOP; DATA VISUALIZATION] </mark></button>
<div class="content">
  <p><ul>
 <h2 style="color:Black;font-size:16px;"> Main Contributions</h2>
<ul > 
...
<div class="responsive-iframe-container">
<iframe src="https://nbviewer.org/github/domlockett91/github.io/blob/master/Final-Assignment.ipynb" frameborder="0" allowfullscreen>></iframe>
</div>
</ul>  
...
<div class="content">
  <p><ul>
  <li><strong>Quantitative political methodology II</strong> <mark style="color:#B8C0AF;background:#f7f7f7;"> (2023)</mark></strong><br>
...
<iframe src="methods.pdf" frameborder="0" width="40%" height="40%"></iframe>
</div>
  
  <li><strong>Computational social science</strong> <mark style="color:#B8C0AF;background:#f7f7f7;"> (2023)</mark><br>
...
This coursed focused on exposing us to different types of data; including networks; text; audio; images; and videos. We began with a mechanistic approaches to supervised and unsupervised learning, then moved to statistical inference with probabilistic interpretations.</li></p>
  ...
  <li><strong>Maximum likelihood estimation</strong> <mark style="color:#B8C0AF;background:#f7f7f7;"> (2023)</mark><br>
  ...
  <li><strong>Causal inference</strong> <mark style="color:#B8C0AF;background:#f7f7f7;">  (2022)</mark><br>
  <p style="padding-left: 20px;">Taught by Julia Park.<br>
  ...
  <li><strong>Applied statistical programming</strong> <mark style="color:#B8C0AF;background:#f7f7f7;"> (2022)</mark><br>
  ...
  <li><strong>Theories of Individual and Collective Choice I</strong><mark style="color:#B8C0AF;background:#f7f7f7;">  (2022)</mark><br>
  ...
  <li><strong>Quantitative political methodology I</strong> <mark style="color:#B8C0AF;background:#f7f7f7;"> (2022)</mark><br>
<p style="padding-left: 20px;">Taught by Guillermo Rosas. Primary materials: <i> Linear Models with R </i>(Julian Faraway). Required.<br>
  ...
  <li><strong>Mathematical modeling</strong> <mark style="color:#B8C0AF;background:#f7f7f7;"> (2021)</mark></mark><br>
  ...
  <li><strong>Research design</strong> <mark style="color:#B8C0AF;background:#f7f7f7;"> (2021)</mark><br>
...
<button class="collapsible">Résumé</button>
<div class="content">
  <p><ul>
  
<div class="responsive-iframe-container">
<iframe src="images/Lockett_resume23.pdf" frameborder="0" allowfullscreen></iframe>
</ul></p>
</div>
