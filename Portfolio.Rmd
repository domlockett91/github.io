...
<ul>
    <div class="image-container" id="imageContainer">
   <img src='images/misinfo3.png' class="image-zoom" id="imageZoom">
 <div></ul>
...
<button class="collapsible"><mark style="color:black;font-size:11px;background:#f5f5f5">INTRODUCTION TO PYTHON FOR PUBLIC HEALTH MASTERS' </mark> <mark style="color:gray;font-size:11px;background:#f5f5f5"> [INSTRUCTION; MACHINE LEARNING; NLP; OOP; DATA VISUALIZATION] </mark></button>
<div class="content">
  <p><ul>
...
<button class="collapsible">Resume</button>
<div class="content">
  <p><ul>
  
<div class="responsive-iframe-container">
<iframe src="images/resume.pdf" frameborder="0" allowfullscreen>></iframe>
</ul></p>
</div>
